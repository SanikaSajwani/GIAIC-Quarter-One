...
var message = '"Marie Curie once said, "One never notices what has been done; one can only see what remains to be done.""';
// Print the message
console.log(message);
// Print a new line for clarity
console.log("\n");
...
console.log("Here is my favorite number: ".concat(favoriteNumber, "."));
// Print a horizontal line
printHorizontalLine(20);
/* Day Four:
...
for (var _i = 0, friends_1 = friends; _i < friends_1.length; _i++) {
    ...
    console.log("Hey ".concat(friend, ", would you like to attend my birthday party?"));
}
// Print a horizontal line
printHorizontalLine(20);
/* Day Five:
...
var transportations = ["Car", "Bike", "Bicycle"];
// Loop through the array using a for...of loop
...
var guests = ["Marie Curie", "Nikola Tesla", "Sylvia Plath"];
// Loop through the array using a for...of loop
for (var _b = 0, guests_1 = guests; _b < guests_1.length; _b++) {
    ...
    console.log("I would like to invite you to dinner, ".concat(guest, "."));
}
// Define a string variable for a guest who is not attending the dinner
var notattending = "Nikola Tesla";
// Print a new line for clarity
console.log("\n");
// Print a message indicating the guest who is not attending
console.log("".concat(notattending, " is not attending the dinner."));
// Print a new line for clarity
console.log("\n");
...
for (var _c = 0, guests_2 = guests; _c < guests_2.length; _c++) {
    var guest = guests_2[_c];
