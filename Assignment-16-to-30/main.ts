...
let guests : string[] = ["Nikola Tesla", "Marie Curie", "Steve Jobs", "Sylvia Plath"];
...
let places: string[] = ["Sahara Dessert", "Kenya", "Quwait", "New Zealand", "Malaysia"];
...
let languages: string[] = ["English", "Urdu", "French", "Spanish"];
...
let Person: { names: string; gender: string; age: number } = {
    names: "Sanika",
    gender: "Female",
    age: 19
};
console.log(`Name: ${Person.names}, Gender: ${Person.gender}, Age: ${Person.age}`);
...
let items: string[] = ["Tablet", "Phone", "Laptop"];
...
let users: string[] = ["user1", "user2", "user3", "admin"];
